...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.nganhang_ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nganhang_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.nganhang_ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nganhang_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.dia_chi"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dia_chi" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.nguoi_lien_he"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nguoi_lien_he" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.dien_thoai"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dien_thoai" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.fax"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="fax" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nganhang.ghi_chu"/></td>
                 <td align="left">
...
<script src="./resources/opec/dm_ngan_hang.js"></script>
