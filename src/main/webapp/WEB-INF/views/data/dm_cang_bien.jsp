...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="cangbien_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="cangbien_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.dia_chi"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dia_chi" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.nguoi_lien_he"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nguoi_lien_he" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.mst"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_so_thue" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.dien_thoai"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dien_thoai" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.fax"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="fax" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.email"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="email" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.quoc_gia"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id='quocgia_id'/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_cang_bien.ghi_chu"/></td>
                 <td align="left">
...
<script src="./resources/opec/dm_cang_bien.js"></script>
