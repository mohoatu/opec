...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
		 <div>
		 	<h3><spring:message code="dm_nsx.title"/></h3>
		 	<hr>
		 </div>
         <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_nsx.id"/></td>
                 <td align="left">
                     <input id="nhasanxuat_id" type="text" readonly="true" disabled="disabled" style="width:100px;" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.ma"/></td>
                 <td align="left">
                     <input id="nhasanxuat_ma" type="text" style="width:100px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.ten"/></td>
                 <td align="left">
                     <input id="nhasanxuat_ten" type="text" style="width:300px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.dia_chi"/></td>
                 <td align="left">
                     <input id="dia_chi" type="text" style="width:300px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.nguoi_lien_he"/></td>
                 <td align="left">
                     <input id="nguoi_lien_he" type="text" style="width:200px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.dien_thoai"/></td>
                 <td align="left">
                     <input id="dien_thoai" type="text" style="width:100px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.fax"/></td>
                 <td align="left">
                     <input id="fax" type="text" style="width:100px;"/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nsx.quoc_tich"/></td>
                 <td align="left">
             ...
             <tr>
                 <td colspan="2" align="right">
                      ...
                      <button style="margin-left: 5px;" id="cancel"><spring:message code="db.cancel"/></button>
                  </td>                    
              </tr>
         </table>
     </div>
