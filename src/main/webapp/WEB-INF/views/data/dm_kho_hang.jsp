...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_kho_hang.ma_kho"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_kho" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_kho_hang.ten_kho"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ten_kho" />
                 </td>
             </tr>
             <tr>
...
<script src="./resources/opec/dm_kho_hang.js"></script>
