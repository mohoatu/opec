...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.phapnhan_ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="phapnhan_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.phapnhan_ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="phapnhan_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.dia_chi"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dia_chi" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.nguoi_lien_he"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nguoi_lien_he" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.ma_so_thue"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_so_thue" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.dien_thoai"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dien_thoai" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.fax"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="fax" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.email"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="email" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.website"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="website" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_phapnhan.ghi_chu"/></td>
                 <td align="left">
...
<script src="./resources/opec/dm_phap_nhan.js"></script>
