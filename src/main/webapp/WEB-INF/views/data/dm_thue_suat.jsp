...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_thuesuat.thuesuat_ty_le"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id="ty_le_thue_suat" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_thuesuat.thuesuat_ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="thuesuat_ten" />
                 </td>
             </tr>
             <tr>
...
<script src="./resources/opec/dm_thue_suat.js"></script>
