...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_mucdoyc.mucdoyc_ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="mucdoyc_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_mucdoyc.mucdoyc_ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="mucdoyc_ten" />
                 </td>
             </tr>
             <tr>
...
<script src="./resources/opec/dm_muc_do_yeu_cau.js"></script>
