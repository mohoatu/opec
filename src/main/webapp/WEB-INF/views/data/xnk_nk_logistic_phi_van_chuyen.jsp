...
<div id='jqxWidget'>
        <div id='jqxTabs'>
            <ul>
                <li style="margin-left: 5px;"><spring:message code="logistic_thu_ho.tab1"/></li>
                <li><spring:message code="logistic_thu_ho.tab2"/></li>
            </ul>
...
<script src="./resources/opec/xnk_nk_logistic_phi_van_chuyen.js"></script>
