...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="chicuchq_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="chicuchq_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.dia_chi"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dia_chi" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.nguoi_lien_he"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nguoi_lien_he" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.mst"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_so_thue" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.dien_thoai"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dien_thoai" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.fax"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="fax" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.email"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="email" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.quoc_gia"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id='quocgia_id'/>
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_chicuchq.ghi_chu"/></td>
                 <td align="left">
