	...
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 ...
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="khachhangnoidia_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_ncc.ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="khachhangnoidia_ten" />
                 </td>
             </tr>
             <tr>
...
<script src="./resources/opec/dm_khach_hang_noi_dia.js"></script>
