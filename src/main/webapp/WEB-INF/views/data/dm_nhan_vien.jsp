...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.nhanvien_ma"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nhanvien_ma" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.nhanvien_ten"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="nhanvien_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.dien_thoai"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="dien_thoai" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.fax"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="fax" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.email"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="email" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_nhanvien.donvi_ten"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id='donvi_id'/>
                 </td>
             </tr>
             <tr>
...
<script src="./resources/opec/dm_phong_ban.js"></script>
<script src="./resources/opec/dm_nhan_vien.js"></script>
