...
<div style="overflow: hidden; visibility: hidden;" id="dialog">
	<div id='jqxWidget' style=" font-size: 14px; font-family: Verdana;" class='content_db'>
        ...
        <table style="table-layout: fixed; border-style: none;">
             <tr>
                 <td align="left"><spring:message code="dm_hang.ma_hang"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_hang" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.ma_noi_bo"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ma_noi_bo" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.code"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="code" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.ten_hang"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="ten_hang" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.don_vi_tinh"/></td>
                 <td align="left">
                     <input type='text' style='float: left; margin-top: 2px;' id="don_vi_tinh" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.phanloai_ten"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id="phanloai_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.nhasanxuat_ten"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id="nhasanxuat_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.ungdung_ten"/></td>
                 <td align="left">
                     <div style='float: left; margin-top: 2px;' id="ungdung_ten" />
                 </td>
             </tr>
             <tr>
                 <td align="left"><spring:message code="dm_hang.ghi_chu"/></td>
                 <td align="left">
...
<script src="./resources/opec/dm_ung_dung.js"></script>
<script src="./resources/opec/dm_nsx.js"></script>
<script src="./resources/opec/dm_don_vi_tinh.js"></script>
<script src="./resources/opec/dm_phan_loai_hang_hoa.js"></script>
<script src="./resources/opec/dm_hang_hoa.js"></script>
