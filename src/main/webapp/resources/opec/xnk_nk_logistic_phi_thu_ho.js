...
function newItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Thêm thông tin phí thu hộ");
...
function editItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Cập nhật thông tin phí thu hộ");
    $("#dialog").jqxWindow('open');
...
function initControl() {
	...
	$("#jqxDataTable2").jqxDataTable(
	{
		...
		columns: [
		          ...
		          { text: 'Thành tiền (có VAT)', datafield: 'ten_cang', width: 80 },
		          { text: 'Đơn vị thanh toán', datafield: 'hang_tau', width: 80 },
