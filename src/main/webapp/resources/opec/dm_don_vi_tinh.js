...
function newItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Thêm đơn vị tính");
...
function editItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Sửa thông tin đơn vị tính");
    $("#dialog").jqxWindow('open');
...
function initControl() {
	...
	$("#jqxDataTable").jqxDataTable(
	{
		...
		pageSize: 20,
		columns: [
		          { text: 'STT', datafield: 'id', width: 100 },
		          { text: 'Tên đơn vị tính', datafield: 'don_vi_tinh' }
		]
	});
	...
	$("#cmdSave").mousedown(function () {
	    ...
	    var url = './dm_don_vi_tinh/update';
	    if(editRow == -1) {
	    	url = './dm_don_vi_tinh/insert';
	    }
...
function initDanhmuc() {
	...
	$("#don_vi_tinh").jqxInput({ height: 25, width: 200 });
...
//-------------------------------------------------------------------------------
function dmDonViTinh() {
	
	var key = "";
	var url = "./dm_don_vi_tinh/get";
