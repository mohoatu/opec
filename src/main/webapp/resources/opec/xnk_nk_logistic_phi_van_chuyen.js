...
function newItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Thêm thông tin phí vận chuyển");
...
function editItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Sửa thông tin phí vận chuyển");
    $("#dialog").jqxWindow('open');
...
function initControl() {
	...
	$("#jqxDataTable2").jqxDataTable(
	{
		...
		pageSize: 20,
		columns: [
		          { text: 'Ngày vận chuyển', datafield: 'code_id', width: 60 },
		          { text: 'Khách hàng', datafield: 'so_hop_dong', width: 100 },
		          { text: 'Địa điểm giao', datafield: 'ten_cang', width: 80 },
		          { text: 'Số lượng cont', datafield: 'hang_tau', width: 80 },
		          { text: 'Giá/cont', datafield: 'so_bill', width: 90 },
		          { text: 'Thành tiền (có VAT)', datafield: 'thanh_tien', width: 90 },
		          { text: 'Đơn vị vận chuyển', datafield: 'don_vi_van_chuyen' }
		]
	});
