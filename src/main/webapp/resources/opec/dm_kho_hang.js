...
function newItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Thêm kho hàng");
...
function editItem() {
	...
	$("#dialog").jqxWindow('setTitle', "Sửa thông tin kho hàng");
    $("#dialog").jqxWindow('open');
    $("#dialog").attr('data-row', row_index);
    $("#jqxDataTable").jqxDataTable({ disabled: true });
    
    $("#ma_kho").jqxInput('val', rowData.ma_kho);
	$("#ten_kho").jqxInput('val', rowData.ten_kho);
...
function initControl() {
	...
	$("#jqxDataTable").jqxDataTable(
	{
		...
		pageSize: 20,
		columns: [
		          { text: 'STT', datafield: 'kho_id', width: 100 },
		          { text: 'Mã kho', datafield: 'ma_kho', width: 250 },
		          { text: 'Tên kho', datafield: 'ten_kho' }
		]
	});
	...
	$("#cmdSave").mousedown(function () {
	    ...
	    rowData.ma_kho = $("#ma_kho").jqxInput('val');
	    rowData.ten_kho = $("#ten_kho").jqxInput('val');
	    
	    var url = './dm_kho_hang/update';
	    if(editRow == -1) {
	    	url = './dm_kho_hang/insert';
	    }
...
function initDanhmuc() {
	...
	$("#ma_kho").jqxInput({ height: 25, width: 100 });
	$("#ten_kho").jqxInput({ height: 25, width: 300 });
...
function dmKhoHang() {
	...
	var source =
	{
			dataType: "json",
			dataFields: [
			             { name: 'kho_id', type: 'int' },
			             { name: 'ma_kho', type: 'string' },
			             { name: 'ten_kho', type: 'string' }
			             ],
			id: 'kho_id',
			url: url
	 };
