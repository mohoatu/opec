...
@Controller
@RequestMapping("/")
public class nk_quytrinh_nhapkhauController {
	...
	@RequestMapping(value="wizardNhapKhau", method = RequestMethod.GET)
	public ModelAndView viewPage()
	{
		ModelAndView modelAndView = new ModelAndView("/data/wizardNhapKhau");
		return modelAndView;
	}
	
	@RequestMapping(value = "/data/dm_quytrinh_xuatkhau", method = RequestMethod.GET)
