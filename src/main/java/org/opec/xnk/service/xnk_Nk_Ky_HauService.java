...
@Service("xnk_Nk_Ky_HauService")
@Transactional
public class xnk_Nk_Ky_HauService {
	...
	public List<xnk_Nk_Ky_Hau> getAll() {
		logger.debug("Lay toan bo ban ghi cua bang du lieu");

		// Retrieve session from Hibernate
		Session session = sessionFactory.getCurrentSession();
		// Create a Hibernate query (HQL)
		Query query = session.createQuery("FROM xnk_Nk_Ky_Hau");
		return  query.list();
	}

	public List<xnk_Nk_Ky_Hau> getByQuery(String fFilterDefault) {
		...
		String hql = "";
		if (fFilterDefault == "")
			hql = "FROM xnk_Nk_Ky_Hau";
		else
			hql = "FROM xnk_Nk_Ky_Hau Where  " + fFilterDefault;
		Query query = session.createQuery(hql);
		return  query.list();
	}

	public xnk_Nk_Ky_Hau getOne(int Code_id) {
		Session session = sessionFactory.getCurrentSession();
		xnk_Nk_Ky_Hau obj = (xnk_Nk_Ky_Hau) session.get(xnk_Nk_Ky_Hau.class, Code_id);
		return obj; 
	}

	public xnk_Nk_Ky_Hau insert(xnk_Nk_Ky_Hau obj) {
...
//		
//		if(fields.keySet().contains("pallet"))
...
//		
//		if(fields.keySet().contains("nguoi_nop_thue"))
